  ...
  return (
    <>
      ...
      <footer className="relative h-[400px] w-full flex">
        ...
        <div className="w-1/2 bg-[#232426] p-8 flex flex-col justify-between">
          <div className="flex flex-col items-start gap-8">
            ...
            <nav className="grid grid-cols-2 gap-x-8 gap-y-4 text-white/90">
              <a href="#" className="hover:text-[#eb6a1e] transition-colors">About</a>
              <a href="#" className="hover:text-[#eb6a1e] transition-colors">Services</a>
              <a href="#" className="hover:text-[#eb6a1e] transition-colors">Projects</a>
              <a href="#" className="hover:text-[#eb6a1e] transition-colors">Contact</a>
              <a href="#" className="hover:text-[#eb6a1e] transition-colors">Blog</a>
              <a href="#" className="hover:text-[#eb6a1e] transition-colors">Careers</a>
            </nav>
          </div>
